...
public class Book {
    ...
    private boolean hasBeenSubScore;
    ...
    public void setHasBeenSubScore(boolean flag) {
        hasBeenSubScore = flag;
    }
    
    public boolean getHasBeenSubScore() {
        return hasBeenSubScore;
    }
