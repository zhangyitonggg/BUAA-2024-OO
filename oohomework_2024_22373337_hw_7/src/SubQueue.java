...
public class SubQueue {
    ...
    public synchronized boolean resetIsNormal() {
        ...
        return resetRequest instanceof NormalResetRequest;
    }
    ...
    public synchronized int getTransferFloor() {
        ...
        return ((DoubleCarResetRequest) resetRequest).getTransferFloor();
    }
    ...
    public synchronized int getNextCap() {
        ...
        if (resetRequest instanceof NormalResetRequest) {
            return ((NormalResetRequest) resetRequest).getCapacity();
        }
        else {
            return ((DoubleCarResetRequest) resetRequest).getCapacity();
        }
    }
    ...
    public synchronized double getNextSpeed() {
        ...
        if (resetRequest instanceof NormalResetRequest) {
            return ((NormalResetRequest) resetRequest).getSpeed();
        }
        else {
            return ((DoubleCarResetRequest) resetRequest).getSpeed();
        }
    }
